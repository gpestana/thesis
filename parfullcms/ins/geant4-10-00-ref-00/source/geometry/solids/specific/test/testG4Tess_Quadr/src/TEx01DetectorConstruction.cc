...
//
//
// $Id: TEx01DetectorConstruction.cc 66356 2012-12-18 09:02:32Z gcosmo $
//
...
//--------- Definitions of Solids, Logical Volumes, Physical Volumes ---------
 ...
 logicWorld= new G4LogicalVolume( solidWorld, Air, "World", 0, 0, 0);
  ...
  G4QuadrangularFacet (G4ThreeVector(-targetSize,-targetSize,-targetSize),
                     G4ThreeVector(-targetSize,+targetSize,-targetSize),
                     G4ThreeVector(+targetSize,+targetSize,-targetSize),
                     G4ThreeVector(+targetSize,-targetSize,-targetSize),
                     ABSOLUTE);
  G4QuadrangularFacet *facet2 = new
  G4QuadrangularFacet (G4ThreeVector(-targetSize,-targetSize/2,+targetSize),
                     G4ThreeVector(+targetSize,-targetSize/2,+targetSize),
                     G4ThreeVector(+targetSize,+targetSize,+targetSize),
                     G4ThreeVector(-targetSize,+targetSize,+targetSize),
                     ABSOLUTE);
  G4QuadrangularFacet *facet3 = new
  G4QuadrangularFacet (G4ThreeVector(-targetSize,-targetSize,-targetSize),
                     G4ThreeVector(+targetSize,-targetSize,-targetSize),
                     G4ThreeVector(+targetSize,-targetSize/2,+targetSize),
                     G4ThreeVector(-targetSize,-targetSize/2,+targetSize),
  ...
  G4QuadrangularFacet (G4ThreeVector(-targetSize,-targetSize,-targetSize),
                     ...
                     G4ThreeVector(-targetSize,+targetSize,-targetSize),
                     ABSOLUTE);
  G4QuadrangularFacet *facet6 = new
  G4QuadrangularFacet (G4ThreeVector(+targetSize,-targetSize,-targetSize),
                     G4ThreeVector(+targetSize,+targetSize,-targetSize),
                     G4ThreeVector(+targetSize,+targetSize,+targetSize),
                     G4ThreeVector(+targetSize,-targetSize/2,+targetSize),
