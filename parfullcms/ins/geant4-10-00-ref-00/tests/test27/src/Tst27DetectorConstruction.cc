...
//
//
// $Id: Tst27DetectorConstruction.cc 71212 2013-06-12 10:15:23Z gcosmo $
//
...
void Tst27DetectorConstruction::SelectMaterial(G4String val)
{
  materialChoice = val;
...
void Tst27DetectorConstruction::SelectMaterialPointer()
{
//--------- Material definition ---------
...
G4VPhysicalVolume* Tst27DetectorConstruction::Construct()
{
  SelectMaterialPointer();
