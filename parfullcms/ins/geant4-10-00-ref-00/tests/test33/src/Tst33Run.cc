...
//
//
// $Id: Tst33Run.cc 66358 2012-12-18 09:07:19Z gcosmo $
//

//=====================================================================
//
//  (Description)
//    Tst33Run Class is for accumulating scored quantities which is 
//  scored using G4MutiFunctionalDetector and G4VPrimitiveScorer.
//  Accumulation is done using G4THitsMap object.
//
//    The constructor Tst33Run(const std::vector<G4String> mfdName)
...
//  Then Tst33Run constructor automatically scans primitive scorers
...
// 
//    The resultant information is kept inside Tst33Run objects as
//  data members.
...
Tst33Run::Tst33Run(const std::vector<G4String> mfdName): G4Run()
{
...
void Tst33Run::RecordEvent(const G4Event* aEvent)
{
...
G4THitsMap<G4double>* Tst33Run::GetHitsMap(const G4String& detName,
...
G4THitsMap<G4double>* Tst33Run::GetHitsMap(const G4String& fullName){
