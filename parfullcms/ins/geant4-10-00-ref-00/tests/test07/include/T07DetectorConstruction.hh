...
//
//
// $Id: T07DetectorConstruction.hh 77281 2013-11-22 10:45:49Z gcosmo $
//
// 
...
#ifndef T07DetectorConstruction_h
#define T07DetectorConstruction_h 1
...
class T07DetectorMessenger;
class T07CalorimeterSD;

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

class T07DetectorConstruction : public G4VUserDetectorConstruction
{
  public:
  
    T07DetectorConstruction();
   ~T07DetectorConstruction();
  ...
  private:
     ...
     T07DetectorMessenger* detectorMessenger;  //pointer to the Messenger
     T07CalorimeterSD* calorimeterSD;  //pointer to the sensitive detector
...
inline void T07DetectorConstruction::ComputeCalorParameters()
{
